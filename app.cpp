...
int main() {
    ...
    while (true) {
        ...
        // Handle commands
        // CLEAR
        // SCROLL <message> with optional speed
        // SET <message> <color>
        // RUN json_template_file
        ...
        if (line == "CLEAR") {
            ...
            sign.parseRenderableList(msg);
            sign.renderAll();
        }

        else if (line.substr(0, 6) == "SCROLL") {
